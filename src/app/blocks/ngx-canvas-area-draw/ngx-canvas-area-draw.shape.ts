...
export class Shape {
    ...
    movePoint: EventEmitter<any> = new EventEmitter();
    moveShape: EventEmitter<any> = new EventEmitter();
    canAddNewPonits: boolean;
    ...
    drawCircle() {
        ...
        this.context.arc(this.points[0][0], this.points[0][1], 40, 0, 2 * Math.PI);
        this.context.stroke();
    ...
    onMousedownOld(event: any, mousePos: any): string {
        const distances = this._getDistances(mousePos);
