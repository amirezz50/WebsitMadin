...
import { UserSessionService, unflatten, arrayToTree, SharedModule, SharedDateService, getNgBsObj, getDateObj } from '../../shared';
import { TranslateService } from '@ngx-translate/core';
import { OutpatientParms } from '../../shared/search-params';     // interface
import { TimeSlotPickerService } from './timeSlotPicker.service'; // service
...
@Component({
  selector: 'timeSlotPicker',
  templateUrl: 'timeSlotPicker.component.html',
  styleUrls: ['./timeSlotPicker.component.css']
})
