...
@Component({
  selector: 'app-portal-pat-examination-history',
  templateUrl: './portal-pat-examination-history.component.html',
  styleUrls: ['./portal-pat-examination-history.component.css']
})
export class PortalPatExaminationHistoryComponent implements OnInit {
  ...
  patServicesLoad(patCode: number) {
    ...
    this.serviceHistoryService.PortalRegPatServiceExaminationLoad(this.patientParms)
