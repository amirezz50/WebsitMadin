...
@Component({
  ...
  host: { '[class]': '"popover show popover-" + placement + " " + displayType', 'role': 'tooltip', '[id]': 'id' },
  template: `
...
export class NgbPopoverWindow {
  ...
  @Input() title: string;
  @Input() id: string;
  @Input() displayType: 'topClassBlock' | 'topClassContents';
}
...
export class NgbPopover implements OnInit, OnDestroy {
  ...
  open(context?: any) {
    if (!this._windowRef) {
      ...
      this._windowRef.instance.displayType = this.displayType;
