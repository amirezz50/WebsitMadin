...
export class UITreeRow implements OnInit {
  ...
  constructor(@Inject(forwardRef(() => TreeTable))
   public treeTable: any,
...
export class TreeTable {
    ...
    @ContentChild(Header, {static: false}) header: Header;

    @ContentChild(Footer, {static: false}) footer: Footer;
...
@NgModule({
  imports: [CommonModule, PrimeNgSharedModule, TranslateModule.forChild()],
