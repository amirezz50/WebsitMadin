 ...
 */
var NumberOfTrialToConnectButHaseError = 0;
...
(function () {
    ...
    var g, k, m = (new Date).getTime() + "-" + Math.floor(1001 * Math.random() + 0);
    ...
    var ba, q, r, t, u, w, y, ca, z, da, A, B, C, D, E, F, G, ea, fa, H, ha, I, ja, ka, J, la, ma, K, na, L, M;
    ba = p("log_level", 0);
    q = p("java_applet_enabled", !1);
    r = !1;
    t = p("scan_app_enabled", !0);
    u = p("scan_app_download_url", "http://cdn.asprise.com/scanapp/scan-setup.exe");
    w = p("scan_app_min_version", "2.04");
    y = p("license", "com_asprise_scan_app_license" in window ? window.com_asprise_scan_app_license : null);
    ca = p("skip_load_default_css", !1);
    z = p("scan_app_port_range_lowest", 9713);
    ...
    ma = p("reverse_request_handler_func", void 0);
    K = !1;
    na = p("additional_css_classes_for_dialogs", "");
    L = p("file_name_base", "scanner");
    M = function () {
        if (!H) {
            I = new Date;
            J && J("pre-init");
            p("skip_fix_formdata_append", !1) || oa();
            N("Initializing Scanner.js v2.11.2 \u00a9 Asprise ...");
            ca || pa();
            if (q && O()) {
                ...
                t && Q() && (!sa() || P.firefox ? window.setTimeout(function () {
    ...
    function U(a, b, c, d, f, e, h, l, v, T) {
        ...
        for (var x = {
            ...
            pageLoadId: wa()
        }, va = [], ia = 2; ia < arguments.length; ia++) va.push(arguments[ia]);
        x.funcArgs = va;
        x = JSON.stringify(x);
        D = "PENDING";
        F = x;
    ...
    function ya() {
        if ("PENDING" == D || "PROCESSING" == D) {
            var a = JSON.parse(F);
            E.push(a);
            N("Canceled func call: " + a.funcName + ", call id: " + a.funcCallId);
            J && J("func-cancelled", a)
        }
        D = void 0
    }
    ...
    function za(a) {
        ...
        if (a && 7 < a.length && "SYSTEM/" == a.substr(0, 7)) try {
            ...
            if (0 < c && "NET" == a.substr(7, 3)) {
                var d = a.substr(0, c);
                Aa(a.substr(c + 1).trim().split("|"), function (a, b) {
                    try {
            ...
            ma ? ma(h, l, function (a, b) {
                try {
                    ...
                    N("Failed to send response to scan app: " + x, !0)
                }
            }) : B.send("RR_RESULT:" + JSON.stringify({
                rr_id: e,
                result: {
            ...
            N("Error while processing RR: " + v, !0)
        } else {
            try {
                b = JSON.parse(a)
            } catch (v) {
    ...
    function X(a, b, c, d, f, e, h) {
        ...
        if (J) try {
            ...
            N("Exception occurred in event handler: " + l, !0)
        }
        try {
            window.focus()
        } catch (l) { }
    ...
    function R(a) {
        ...
        if (t)
            if (B) C = void 0, B.close();
                ...
                void 0 == A ? A = z : void 0 != C && 1E4 > (new Date).getTime() - C && (A += 1);
                A % 2 != (a ? 0 : 1) && (A += 1);
                if (A < z || A > da) N("Failed to connect to WebSocket server.", !0), J && J("failed-to-connect"), O(), R();
                else {
                    C = (new Date).getTime();
                    a = Fa;
                    b = b + ":" + A + "/" + wa() + "/";
    ...
    function ra() {
        var a;
        (a = Ga()) || (a = "https://cdn.asprise.com/scannerjs/"); - 1 < a.indexOf("FORCE_REFRESH") && -1 < window.location.href.indexOf("FORCE_REFRESH") && (a = a.replace(/FORCE_REFRESH/g, "FORCE_REFRESH_" + (new Date).getTime()));
    ...
    function ua(a) {
        if ("function" != typeof ja || ja(a)) H ? Ha(a) : (M(), a || Ha(a))
    }
            ...
            if (!b) {
                b = {
                    ...
                    attributes: {
                        ...
                        "class": "asprise-web-scan-dialog-wrapper " + na
                    },
                    children: [{
                        name: "div",
                        attributes: {
    ...
    function pa() {
        ...
        a || (a = Ga() + L + ".css", b = document.createElement("link"), b.setAttribute("rel", "stylesheet"), b.setAttribute("type", "text/css"), b.setAttribute("href", a), document.getElementsByTagName("head")[0].appendChild(b))
    }
    ...
    function Aa(a, b) {
        ...
        if (0 == a.length) b(!1, null);
            ...
            d.onreadystatechange = function () {
                d.readyState === XMLHttpRequest.DONE && (200 <= d.status && 300 > d.status ? b(!0, d.responseText) : (N("Failed to " + c + ": " + d.statusText, !0), Aa(a, b)))
            };
            d.send()
        }
    }
    function Fa(a) {
        ...
        "function" === typeof Da ? b.onopen = function () {
            Da(b)
        } : (N("No onOpenFunc specified for " + a), b.onopen = function () {
            N("WebSocket [" + b.url + "] opens.")
        });
        "function" === typeof Ea ? b.onclose = function () {
            Ea()
        } : (N("No onCloseFunc specified for " + a), b.onclose = function (a) {
            N("WebSocket [" + b.url + "] closes: " + a.code + " / " + a.reason + " / clean? " + a.A)
        });
        "function" === typeof Ba ? (b.onmessage = function (a) {
            Ba(a)
        }, b.onerror = function (a) {
            NumberOfTrialToConnectButHaseError = NumberOfTrialToConnectButHaseError + 1;
    ...
    function wa() {
        window.sessionStorage && (sessionStorage.getItem("pageLoadId") ? m = sessionStorage.getItem("pageLoadId") : sessionStorage.setItem("pageLoadId", m));
        return m
    }
    ...
    window.scannerjs.getSource = function (a, b, c, d, f, e, h, l) {
        return U(a, "getSource", 2 <= arguments.length ? b : "select", 3 <= arguments.length ? c : !0, 4 <= arguments.length ? d : null, 5 <= arguments.length ? f : !0, 6 <= arguments.length ? e : !1, 7 <= arguments.length ? h : null, 8 <= arguments.length && null != l ? "string" === typeof l ? l : JSON.stringify(l) : "")
    };
        ...
        if ("object" === typeof a && a.output instanceof Array)
            for (var f = a.output, e = 0; e < f.length; e++) {
                ...
                if (b && "return-base64" == h.type || c && "return-base64-thumbnail" == h.type) {
                    var l = h.format;
                    l = null == l ? "application/octet-stream" : 0 <= l.toLowerCase().indexOf("bmp") ? "image/bmp" : 0 <= l.toLowerCase().indexOf("png") ? "image/png" : 0 <= l.toLowerCase().indexOf("jp") ? "image/jpeg" : 0 <= l.toLowerCase().indexOf("tif") ? "image/tiff" : 0 <= l.toLowerCase().indexOf("pdf") ? "application/pdf" : "application/octet-stream";
                    if ("application/octet-stream" == l) N("Unable to find mime type for " + h.format);
                    else if (h.result instanceof Array)
                        for (var v = 0; v < h.result.length; v++) {
                            var T = a.images instanceof Array && v < a.images.length ? a.images[v] : null;
                            d.push(new n(l, !0, "data:" + l + ";base64," + h.result[v], T, T ? T.image_info : void 0, h.hasOwnProperty("selected_action") ? h.selected_action : void 0, h.hasOwnProperty("selected_filename") ? h.selected_filename : void 0))
    ...
    window.scannerjs.getScannerJsConfig = p;
    window.scannerjs.cancelFuncCalls = ya;
    ...
    window.scannerjs.fadeOut = Ia;
    window.scannerjs.hasJava = sa;
    ...
    window.scannerjs.version = "2.11.2";
    ...
    window.scannerjs.displaySetupDialog = Ha;
    window.scannerjs.doAjax = Aa;
    window.scannerjs.ScannedImage = n;
    window.scannerjs.ScannedImage.prototype.getMimeType = n.prototype.v;
    window.scannerjs.ScannedImage.prototype.getSrcIsBase64 = n.prototype.w;
    window.scannerjs.ScannedImage.prototype.getImageInfo = n.prototype.s;
    window.scannerjs.ScannedImage.prototype.getInfo = n.prototype.u;
    window.scannerjs.ScannedImage.prototype.getWidth = n.prototype.h;
    window.scannerjs.ScannedImage.prototype.getHeight = n.prototype.f;
    window.scannerjs.ScannedImage.prototype.isColor = n.prototype.j;
    window.scannerjs.ScannedImage.prototype.isGray = n.prototype.l;
    window.scannerjs.ScannedImage.prototype.isBlackWhite = n.prototype.i;
    window.scannerjs.ScannedImage.prototype.getResolution = n.prototype.g;
    window.scannerjs.ScannedImage.prototype.getBitsPerPixel = n.prototype.c;
    window.scannerjs.ScannedImage.prototype.getBase64NoPrefix = n.prototype.o;
    window.scannerjs.ScannedImage.prototype.toString = n.prototype.toString;
